...
const translations = {
  en: {
    ...
    connect_desc: "Use an Ed25519 did:key controlled by another wallet, agent or signer. FLOP stores only the public DID.",
  ...
  tr: {
    ...
    connect_desc: "Başka bir wallet, ajan veya signer'ın kontrol ettiği Ed25519 did:key kullan. FLOP yalnızca public DID'yi tutar.",
